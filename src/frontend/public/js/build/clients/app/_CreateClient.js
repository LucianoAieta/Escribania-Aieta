        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, verifyIfIsEmpty(this.client)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, confirmCard("\u00BFEst\u00E1s seguro de crear el cliente " + this.client.name + " " + this.client.surname + "?", ['Crear', 'Cancelar'])];
                    case 2:
                        _a.sent();
                        CreateClientCard.hideCard();
                        return [4 /*yield*/, ClientPost.createClient(this.client)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
